                ...
                child: Row(
                  children: [
                    ImagemPerfilWidget(
                      ...
                      onTap: () {
                        novoUsuario.imagemPerfil = linksImagens[0];
                      },
                      tamanhoImagem: 70,
                    ),
                    ImagemPerfilWidget(
                      ...
                      onTap: () {
                        novoUsuario.imagemPerfil = linksImagens[1];
                      },
                      tamanhoImagem: 70,
                    ),
                    ImagemPerfilWidget(
                      ...
                      onTap: () {
                        novoUsuario.imagemPerfil = linksImagens[2];
                      },
                      tamanhoImagem: 70,
                    ),
                    ImagemPerfilWidget(
                      ...
                      onTap: () {
                        novoUsuario.imagemPerfil = linksImagens[3];
                      },
                      tamanhoImagem: 70,
                    ),
                  ],
                ...
                child: Row(
                  children: [
                    ImagemPerfilWidget(
                      ...
                      onTap: () {
                        novoUsuario.imagemPerfil = linksImagens[4];
                      },
                      tamanhoImagem: 70,
                    ),
                    ImagemPerfilWidget(
                      ...
                      onTap: () {
                        novoUsuario.imagemPerfil = linksImagens[5];
                      },
                      tamanhoImagem: 70,
                    ),
                    ImagemPerfilWidget(
                      ...
                      onTap: () {
                        novoUsuario.imagemPerfil = linksImagens[6];
                      },
                      tamanhoImagem: 70,
                    ),
                    ImagemPerfilWidget(
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: BotaoPadrao(
                    value: "Definir",
                    onTap: () {
                      _controladorUsuario.cadastrarUsuario(novoUsuario,
                          sucesso: () {
                        Navigator.of(context).pushNamedAndRemoveUntil(
                            "/telaPrincipal", (Route<dynamic> route) => false);
                      }, erro: (mensagem) {
                        UtilDialogo.exibirAlerta(context,
                            titulo: "Falha no cadastro", mensagem: mensagem);
                        Navigator.pop(context);
                      });
                    },
                  ),
